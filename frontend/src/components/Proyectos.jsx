...
const proyectos = [
  {
    ...
    imagen:
      "https://www.dearquitectura.com.mx/wp-content/uploads/2021/05/remodelacion-de-sala.jpg",
  },
  {
    ...
    imagen:
      "https://closetsorbis.com/puertas-para-interiores/slides/puertas-interiores-de-madera-y-melamina.webp",
  },
  {
    ...
    imagen:
      "https://www.oppoliahome.com/wp-content/uploads/2023/06/big-walk-in-closet-with-beige-and-light-wood-cabinets-obw23-l05-9-1024x640.webp",
  },
  {
    ...
    icono: <FaHammer className="text-white text-3xl" />,
    imagen:
      "https://www.cocinascjr.com/wp-content/uploads/2021/03/Cocinas-Blanco-Mate-03-scaled.jpg",
  },
  {
    ...
    icono: <FaTools className="text-white text-3xl" />,
    imagen:
      "https://www.azulev.com/wp-content/uploads/2023/05/APG_CALACATTA_BLACK_120X120_CALACATTA_BLACK_60X120_RG-1024x768.jpg",
  },
  {
    ...
    icono: <FaPaintRoller className="text-white text-3xl" />,
    imagen:
      "https://sanjuecompany.com/wp-content/uploads/2024/07/Landing-Page-banner-04.png",
  },
  {
    ...
    icono: <FaHammer className="text-white text-3xl" />,
    imagen:
      "https://www.ledvance.lat/10_LEDVANCE_only/5067015/image-thumb__5067015__news_detail/asset-5067015_SMART-2B_Multicolor_Living_Room_with_Apple_HomePod_Side_Angle.jpg",
  },
  {
    ...
    icono: <FaTools className="text-white text-3xl" />,
    imagen:
      "https://image.architonic.com/pfm3-3/20194122/36e8-tv-unit--fam-g-arcit18.jpg",
  },
  {
    ...
    icono: <FaPaintRoller className="text-white text-3xl" />,
    imagen:
      "https://jelaperu.com/blog/wp-content/uploads/2021/08/Escritorio-con-espacio-de-circulacion-1024x687.jpg",
  },
];
    ...
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-10 relative">
        ...
        {!isMobile ? (
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex justify-center gap-3 mt-6">
              <motion.button
                onClick={handlePrev}
                className="absolute top-1/2 left-6 md:-left-17 z-10 bg-black text-white text-2xl p-3 rounded-full"
                whileHover={{ scale: 1.2, backgroundColor: "#ffffff40" }}
              ...
              <motion.button
                onClick={handleNext}
                className="absolute top-1/2 right-6 md:-right-17 z-10 bg-black text-white text-2xl p-3 rounded-full"
                whileHover={{ scale: 1.2, backgroundColor: "#ffffff40" }}
                transition={{ type: "spring", stiffness: 250 }}
              >
                ▶
        ...
        >
          <a href="#contacto">
            <motion.button
              className="px-6 py-3 bg-white/10 text-white font-semibold rounded-xl hover:bg-white hover:text-black transition"
